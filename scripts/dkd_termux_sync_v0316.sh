...
DKD_BACKUP_ZIP="$DKD_DOWNLOAD_DIR/DraBornGate_Local_Before_v0.3.16_Sync_$DKD_TIMESTAMP.zip"
...
echo "[2/6] GitHub geri alma dalı doğrulanıyor..."
...
echo "[3/6] Lokal main GitHub main ile birebir eşitleniyor..."
git checkout main
