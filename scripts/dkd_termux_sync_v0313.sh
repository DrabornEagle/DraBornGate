...
DKD_DOWNLOAD_DIR="/sdcard/Download"
DKD_BACKUP_BRANCH="backup/draborngate-v0.3.12-before-v0.3.13"
DKD_TIMESTAMP="$(date +%Y%m%d_%H%M%S)"
DKD_BACKUP_ZIP="$DKD_DOWNLOAD_DIR/DraBornGate_Backup_v0.3.12_before_v0.3.13_$DKD_TIMESTAMP.zip"
...
echo "[2/6] GitHub yedek dalı doğrulanıyor..."
git fetch --prune origin
git show-ref --verify --quiet "refs/remotes/origin/$DKD_BACKUP_BRANCH"

echo "[3/6] Yerel main, GitHub main ile birebir eşitleniyor..."
git checkout main
