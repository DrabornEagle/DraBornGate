...
DKD_BACKUP_ZIP="$DKD_DOWNLOAD_DIR/DraBornGate_Local_Before_v0.3.17_Sync_$DKD_TIMESTAMP.zip"
...
echo "[2/6] GitHub v0.3.16 geri alma dalı doğrulanıyor..."
