...
const s = StyleSheet.create({
  ...
  securityCodeWrap: { width: 150, alignItems: 'stretch' }, securityCodeLabel: { color: colors.orange, fontSize: 8, fontWeight: '900', textAlign: 'center', letterSpacing: .7 }, securityCode: { color: colors.text, fontSize: 21, fontWeight: '900', letterSpacing: 4, textAlign: 'center', marginTop: 2 }, matchButton: { minHeight: 38, marginTop: 6, borderRadius: 13, borderWidth: 1, borderColor: 'rgba(139,107,255,.62)', backgroundColor: 'rgba(139,107,255,.14)', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 5, paddingHorizontal: 7 }, matchButtonDisabled: { opacity: .65 }, matchButtonText: { color: colors.purple, fontSize: 9, fontWeight: '900' },
