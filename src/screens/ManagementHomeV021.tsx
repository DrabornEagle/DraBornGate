      ...
      {tab === 'finance' ? (
        site ? (
          <>
            ...
            <Panel style={styles.notePanel} gradient><Field label="Elle ödeme notu" value={paymentNote} onChangeText={setPaymentNote} placeholder="Örn. Yönetim tarafından ödendi işaretlendi / Makbuz 124" /><Text style={styles.noteHelp}>Aşağıdaki “Ödendi” veya “Geri Al” işleminde bu not kullanılır.</Text></Panel>
